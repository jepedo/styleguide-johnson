...
var lessWild = styleSourcePath + '/**/*.less';
var lessRoot = styleSourcePath + '/rsa.less';
...
gulp.task('dev', ['html', 'less', 'styleguide'], function() {
    gulp.watch(htmlWild, ['html']);
    gulp.watch(lessWild, ['less', 'styleguide']);
    console.log(
...
gulp.task('default', ['html', 'less', 'staticStyleguide'], function() {
    console.log(
